...
@Controller
@RequestMapping("/private/merchantBankCard")
public class MerchantBankCarController {
    @Autowired
    ...
    public String bankCardList(Model model){
        ...
        return "business/merchant/bankCard/list";
    }
    ...
    public String add(Model model){
        ...
        return "business/merchant/bankCard/form";
    }
    ...
    public String add(Model model, @ModelAttribute BankCard bankCard){
        try{
            ...
            return "redirect:/private/merchantBankCard/bankCardList";
        }catch (Exception e){
