...
@Controller
@RequestMapping("/private/walletLog")
public class WalletLogController {
    ...
    public String findListWalletLog(@ModelAttribute WalletLogReq walletLogReq, Model model, @ModelAttribute Pager pager){
        pager.setSize(20);
        Page<WalletLogVo> listByCondition = walletLogService.findAdminWalletLogList(walletLogReq, pager);
        ...
        return "business/admin/walletLog/list";
