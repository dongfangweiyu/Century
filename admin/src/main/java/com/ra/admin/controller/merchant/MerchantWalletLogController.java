...
@Controller
@RequestMapping("/private/merchantWalletLog")
public class MerchantWalletLogController {
    ...
    public String findListWalletLog(@ModelAttribute WalletLogReq walletLogReq, Model model, @ModelAttribute Pager pager){
        long merchangUserId=TokenUtil.getLoginId();
        Page<WalletLogVo> listByCondition = walletLogService.findWalletLogList(walletLogReq, merchangUserId, pager);
        ...
        return "business/merchant/walletLog/list";
