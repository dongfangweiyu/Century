...
@Controller
@RequestMapping("/private/merchantPayOrder")
public class MerchantPayOrderController {
    ...
    @RequestMapping(value = "/findListMerchantPayOrder", method = RequestMethod.GET)
    public String findListMerchantPayOrder(@ModelAttribute PayOrderReq payOrderReq, Model model, @ModelAttribute Pager pager){
        pager.setSize(20);
        long merchantUserId= TokenUtil.getLoginId();
        Page<PayOrderVo> listByCondition = payOrderService.findListByMerchantPayOrder(payOrderReq, merchantUserId,pager);
        ...
        BigDecimal merchantOrderTotal=payOrderService.findByMerchantPayOrderTotal(payOrderReq,merchantUserId);
        model.addAttribute("listByCondition", listByCondition).addAttribute("paycodeList", paycodeList)
                ...
                .addAttribute("pager", pager).addAttribute("merchantOrderTotal",merchantOrderTotal);
        return "business/merchant/payOrder/list";
    }
