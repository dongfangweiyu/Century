...
@Controller
@RequestMapping("/private/proxyWalletlog")
public class ProxyWalletLogController {
    @Autowired
    ...
    public String findListWalletLog(@ModelAttribute WalletLogReq walletLogReq, Model model, @ModelAttribute Pager pager){
        ...
        Page<WalletLogVo> listByCondition = walletLogService.findWalletLogList(walletLogReq, TokenUtil.getLoginId(), pager);
      /*  Double allWalletLog=walletLogService.findByWalletLogTotal(walletLogReq,TokenUtil.getLoginId());*/
        ...
        return "business/proxy/walletLog/list";
