...
public final class RSAUtil {
    ...
    public static PublicKey getPublicRSAKey(String key) throws Exception {  
        X509EncodedKeySpec x509 = new X509EncodedKeySpec(org.apache.commons.codec.binary.Base64.decodeBase64(key));  
    ...
    public static PrivateKey getPrivateRSAKey(String key) throws Exception {  
        PKCS8EncodedKeySpec pkgs8 = new PKCS8EncodedKeySpec(org.apache.commons.codec.binary.Base64.decodeBase64(key));  
        KeyFactory kf = KeyFactory.getInstance(KEY_ALGORITHM_RSA);  
