 ...
 * 与第三方对接的具体实现
 */
public class GodsPayInterface extends CommonPayInterface {
    ...
    public String onNotify(HttpServletRequest request) {
        ...
        try{
            // 延签
            // 验证是不是支付网关发来的异步通知
            String sign=generateCreateSign(outOrderNo,payOrder.getAmount(),payType,attach,appId, Long.parseLong(timestamp),nonceStr,serect );
