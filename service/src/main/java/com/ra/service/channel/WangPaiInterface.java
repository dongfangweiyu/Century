...
/**
 * https://ipay.beslink.co/ht.php?c=Login 接口
 * 与王牌第三方对接的具体实现
 */
public class WangPaiInterface extends CommonPayInterface {
        ...
        try{
            ...
            if (sign.equals(notifySign)) {
                ...
                if(status.equals("success")){
                    ...
                    params.put("sign",getSign(params,token).toLowerCase());
                    String result = HttpUtil.doPOST("https://ipay.beslink.co/?c=Pay&a=query", params);
                    logger.info("王牌:查询订单结果返回的JSON："+result);
